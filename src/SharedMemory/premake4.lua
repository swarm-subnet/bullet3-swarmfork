...
includedirs {".","..", "../../examples/ThirdPartyLibs"}
...
language "C++"
	...
	if _OPTIONS["midi"] then
		...
		defines {"B3_USE_MIDI"}
			 ...
			 includedirs{"../../examples/ThirdPartyLibs/midi"}
...
if (_OPTIONS["enable_static_vr_plugin"]) then
	...
	if os.is("Windows") then 
		configuration {"x32"}
			libdirs {"../../examples/ThirdPartyLibs/openvr/lib/win32"}
		configuration {"x64"}
			libdirs {"../../examples/ThirdPartyLibs/openvr/lib/win64"}
		configuration{}
	end
