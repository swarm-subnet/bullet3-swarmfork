...
struct BodyJointInfoCache2
{
	...
	btHashMap<btHashInt, MuJoCoUserDataCache> m_jointToUserDataMap;
...
struct MuJoCoPhysicsDirectInternalData
{
	...
	MuJoCoPhysicsDirectInternalData()
		: m_hasStatus(false),
...
MuJoCoPhysicsClient::MuJoCoPhysicsClient(PhysicsCommandProcessorInterface* physSdk, bool passSdkOwnership)
{
	int sz = sizeof(SharedMemoryCommand);
	int sz2 = sizeof(SharedMemoryStatus);

	m_data = new MuJoCoPhysicsDirectInternalData;
	m_data->m_commandProcessor = physSdk;
	m_data->m_ownsCommandProcessor = passSdkOwnership;
}

MuJoCoPhysicsClient::~MuJoCoPhysicsClient()
{
...
void MuJoCoPhysicsClient::resetData()
{
...
void MuJoCoPhysicsClient::renderScene()
{
	int renderFlags = 0;
	m_data->m_commandProcessor->renderScene(renderFlags);
}

void MuJoCoPhysicsClient::debugDraw(int debugDrawMode)
{
	m_data->m_commandProcessor->physicsDebugDraw(debugDrawMode);
}

////todo: rename to 'disconnect'
void MuJoCoPhysicsClient::disconnectSharedMemory()
{
	m_data->m_commandProcessor->disconnect();
	m_data->m_commandProcessor->setGuiHelper(0);
}

bool MuJoCoPhysicsClient::isConnected() const
{
	return m_data->m_commandProcessor->isConnected();
}

// return non-null if there is a status, nullptr otherwise
const SharedMemoryStatus* MuJoCoPhysicsClient::processServerStatus()
{
...
SharedMemoryCommand* MuJoCoPhysicsClient::getAvailableSharedMemoryCommand()
{
	return &m_data->m_command;
}

bool MuJoCoPhysicsClient::canSubmitCommand() const
{
	return m_data->m_commandProcessor->isConnected();
}

bool MuJoCoPhysicsClient::processDebugLines(const struct SharedMemoryCommand& orgCommand)
{
...
bool MuJoCoPhysicsClient::processVisualShapeData(const struct SharedMemoryCommand& orgCommand)
{
	SharedMemoryCommand command = orgCommand;
	const SharedMemoryStatus& serverCmd = m_data->m_serverStatus;
...
bool MuJoCoPhysicsClient::processOverlappingObjects(const struct SharedMemoryCommand& orgCommand)
{
	SharedMemoryCommand command = orgCommand;
...
bool MuJoCoPhysicsClient::processContactPointData(const struct SharedMemoryCommand& orgCommand)
{
	SharedMemoryCommand command = orgCommand;
...
bool MuJoCoPhysicsClient::processCamera(const struct SharedMemoryCommand& orgCommand)
{
	SharedMemoryCommand command = orgCommand;
...
void MuJoCoPhysicsClient::processBodyJointInfo(int bodyUniqueId, const SharedMemoryStatus& serverCmd)
{
...
void MuJoCoPhysicsClient::processAddUserData(const struct SharedMemoryStatus& serverCmd)
{
	...
	if (bodyJointsPtr && *bodyJointsPtr)
	{
		MuJoCoUserDataCache* userDataCachePtr = (*bodyJointsPtr)->m_jointToUserDataMap[userDataGlobalId.m_linkIndex];
		if (!userDataCachePtr)
		{
			MuJoCoUserDataCache cache;
...
void MuJoCoPhysicsClient::postProcessStatus(const struct SharedMemoryStatus& serverCmd)
{
...
bool MuJoCoPhysicsClient::submitClientCommand(const struct SharedMemoryCommand& command)
{
...
int MuJoCoPhysicsClient::getNumBodies() const
{
	return m_data->m_bodyJointMap.size();
}

void MuJoCoPhysicsClient::removeCachedBody(int bodyUniqueId)
{
...
int MuJoCoPhysicsClient::getNumUserConstraints() const
{
	return m_data->m_userConstraintInfoMap.size();
}

int MuJoCoPhysicsClient::getUserConstraintInfo(int constraintUniqueId, struct b3UserConstraint& info) const
{
...
int MuJoCoPhysicsClient::getUserConstraintId(int serialIndex) const
{
...
int MuJoCoPhysicsClient::getBodyUniqueId(int serialIndex) const
{
...
bool MuJoCoPhysicsClient::getBodyInfo(int bodyUniqueId, struct b3BodyInfo& info) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (bodyJointsPtr && *bodyJointsPtr)
	{
...
int MuJoCoPhysicsClient::getNumJoints(int bodyIndex) const
{
...
bool MuJoCoPhysicsClient::getJointInfo(int bodyIndex, int jointIndex, struct b3JointInfo& info) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyIndex];
	if (bodyJointsPtr && *bodyJointsPtr)
	{
...
void MuJoCoPhysicsClient::setSharedMemoryKey(int key)
{
}

void MuJoCoPhysicsClient::uploadBulletFileToSharedMemory(const char* data, int len)
{
...
void MuJoCoPhysicsClient::uploadRaysToSharedMemory(struct SharedMemoryCommand& command, const double* rayFromWorldArray, const double* rayToWorldArray, int numRays)
{
...
int MuJoCoPhysicsClient::getNumDebugLines() const
{
	return m_data->m_debugLinesFrom.size();
}

const float* MuJoCoPhysicsClient::getDebugLinesFrom() const
{
	if (getNumDebugLines())
	{
...
const float* MuJoCoPhysicsClient::getDebugLinesTo() const
{
	if (getNumDebugLines())
	{
...
const float* MuJoCoPhysicsClient::getDebugLinesColor() const
{
	if (getNumDebugLines())
	{
...
void MuJoCoPhysicsClient::getCachedCameraImage(b3CameraImageData* cameraData)
{
	if (cameraData)
	{
...
void MuJoCoPhysicsClient::getCachedContactPointInformation(struct b3ContactInformation* contactPointData)
{
...
void MuJoCoPhysicsClient::getCachedOverlappingObjects(struct b3AABBOverlapData* overlappingObjects)
{
...
void MuJoCoPhysicsClient::getCachedVisualShapeInformation(struct b3VisualShapeInformation* visualShapesInfo)
{
...
void MuJoCoPhysicsClient::getCachedCollisionShapeInformation(struct b3CollisionShapeInformation* collisionShapesInfo)
{
...
void MuJoCoPhysicsClient::getCachedVREvents(struct b3VREventsData* vrEventsData)
{
...
void MuJoCoPhysicsClient::getCachedKeyboardEvents(struct b3KeyboardEventsData* keyboardEventsData)
{
...
void MuJoCoPhysicsClient::getCachedMouseEvents(struct b3MouseEventsData* mouseEventsData)
{
...
void MuJoCoPhysicsClient::getCachedRaycastHits(struct b3RaycastInformation* raycastHits)
{
...
void MuJoCoPhysicsClient::getCachedMassMatrix(int dofCountCheck, double* massMatrix)
{
...
void MuJoCoPhysicsClient::setTimeOut(double timeOutInSeconds)
{
	m_data->m_timeOutInSeconds = timeOutInSeconds;
}

double MuJoCoPhysicsClient::getTimeOut() const
{
	return m_data->m_timeOutInSeconds;
}

bool MuJoCoPhysicsClient::getCachedUserData(int bodyUniqueId, int linkIndex, int userDataId, struct b3UserDataValue& valueOut) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
	...
	MuJoCoUserDataCache* userDataCachePtr = (*bodyJointsPtr)->m_jointToUserDataMap[linkIndex];
	if (!userDataCachePtr)
	{
		return false;
	}
...
int MuJoCoPhysicsClient::getCachedUserDataId(int bodyUniqueId, int linkIndex, const char* key) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
int MuJoCoPhysicsClient::getNumUserData(int bodyUniqueId, int linkIndex) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
void MuJoCoPhysicsClient::getUserDataInfo(int bodyUniqueId, int linkIndex, int userDataIndex, const char** keyOut, int* userDataIdOut) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (!bodyJointsPtr || !(*bodyJointsPtr))
	{
...
void MuJoCoPhysicsClient::pushProfileTiming(const char* timingName)
{
...
void MuJoCoPhysicsClient::popProfileTiming()
{
