...
void DARTPhysicsClient::debugDraw(int debugDrawMode)
{
...
int DARTPhysicsClient::getNumBodies() const
{
	return m_data->m_bodyJointMap.size();
}

void DARTPhysicsClient::removeCachedBody(int bodyUniqueId)
{
...
int DARTPhysicsClient::getBodyUniqueId(int serialIndex) const
{
...
bool DARTPhysicsClient::getBodyInfo(int bodyUniqueId, struct b3BodyInfo& info) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyUniqueId];
	if (bodyJointsPtr && *bodyJointsPtr)
	{
...
int DARTPhysicsClient::getNumJoints(int bodyIndex) const
{
...
bool DARTPhysicsClient::getJointInfo(int bodyIndex, int jointIndex, struct b3JointInfo& info) const
{
	BodyJointInfoCache2** bodyJointsPtr = m_data->m_bodyJointMap[bodyIndex];
	if (bodyJointsPtr && *bodyJointsPtr)
	{
...
void DARTPhysicsClient::uploadRaysToSharedMemory(struct SharedMemoryCommand& command, const double* rayFromWorldArray, const double* rayToWorldArray, int numRays)
{
