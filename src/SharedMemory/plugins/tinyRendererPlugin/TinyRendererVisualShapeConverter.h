...
#include "../../../../examples/Importers/ImportURDFDemo/UrdfRenderingInterface.h"
...
struct TinyRendererVisualShapeConverter : public UrdfRenderingInterface
{
	...
	void paintSky(const float viewMat[16], const float projMat[16], const class SwarmSky* sunSky, bool daylight);
