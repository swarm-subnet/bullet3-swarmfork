...
#include <Python.h>
	...
	#define _DEBUG
#endif
#include "../../examples/Importers/ImportURDFDemo/urdfStringSplit.h"
...
#endif
{
	...
	PyModule_AddIntConstant(m, "URDF_USE_MATERIALS_FROM_MTL", URDF_USE_MATERIALS_FROM_MTL);
	...
	PyModule_AddIntConstant(m, "VISUAL_SHAPE_DOUBLE_SIDED_MULTIBODY", eVISUAL_SHAPE_DOUBLE_SIDED_MULTIBODY);
	PyModule_AddIntConstant(m, "VISUAL_SHAPE_MATERIALS_FROM_MTL", eVISUAL_SHAPE_MATERIALS_FROM_MTL);
	...
	PyModule_AddIntConstant(m, "GEOM_CONCAVE_BVH_CACHE", GEOM_CONCAVE_BVH_CACHE);
