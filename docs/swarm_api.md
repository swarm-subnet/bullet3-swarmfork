...
| `daylightTest.py` | `ER_SWARM_DAYLIGHT`: flag off unchanged, sun to sky ratio, sky light by direction, exposure, photo sky and yaw, haze, soft shadow, leaf light, a far cut-out as an even veil with near lines still sharp, thread counts |
